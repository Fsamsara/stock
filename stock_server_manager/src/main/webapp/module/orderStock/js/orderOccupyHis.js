function orderOccupyHisloadData() {
	var basePath = "/" + ump.mvcContextPath;
	var modularPath = {
		selectUrl : basePath + "/selectOrderOccupyHis",
		channelInfoSelectUrl : basePath + "/selectChannelInfo"
	}
	var search_selector = "#orderOccupyHisSearch";
	var grid_selector = "#orderOccupyHisTable";
	var pager_selector = "#orderOccupyHisPager";
