...
@SuppressWarnings("deprecation") public class HttpClientUtil {
    ...
    public static String postXmlFile1(String url, List<NameValuePair> pms, String xmlpostname, String xml) throws IOException {
        ...
        connection.addRequestProperty("Content-Type", "multipart/form-data; boundary=FoeeWxM0WaLNKwsc5Tj6_W7O5Fd9n7");

        //		connection.addRequestProperty("Content-Length",
        //				xml.getBytes("GBK").length + "");

        xml = "--FoeeWxM0WaLNKwsc5Tj6_W7O5Fd9n7\r\n" + "Content-Disposition: form-data; name=\"" + xmlpostname + "\"; filename=\"sendGoods.xml\"\r\n"
    ...
    public static void main(String[] args) {
        ...
        NameValuePair nvp = new BasicNameValuePair("method", "setWmsPropert");
        NameValuePair nvp1 = new BasicNameValuePair("param", "[{\"warehId\":\"HQ01WTST\",\"usedMa\":\"0\"}]");
        item.add(nvp);
        item.add(nvp1);

        String s = HttpClientUtil.post("http://127.0.0.1:8080/stock_server_api/dubbo/com.metersbonwe.stock.facade.api.WmsPropertyFacade", item);
