package com.metersbonwe.stock.ds.core;
 ...
 * @author zhangfeng
 */
@Intercepts({ @Signature(method = "prepare", type = StatementHandler.class, args = { Connection.class }) }) public class PageInterceptorForCore
        implements Interceptor {
    private final static StockLog LOGGER = StockLogFactory.getLogger(PageInterceptorForCore.class);
    ...
    private String getPageSql(String sql, Page<?> page) {
        ...
        sqlBuffer.append(" limit ").append((page.getPageNo() - 1) * page.getPageSize()).append(",").append(page.getPageNo() * page.getPageSize());
