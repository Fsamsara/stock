 ...
 * @date 2016/5/6
 */
public interface StockDiffBetweenOnlineAndSendedService {
     ...
     * @return 在售商品清单Map
     */
    List<ChannelProdBean> selectStockDiffBetweenOnlineAndSended(Map<String, String> channelCode, Page<?> page) throws Exception;
